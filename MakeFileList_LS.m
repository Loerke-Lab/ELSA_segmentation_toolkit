...
for ii=1:Nfiles
    ...
    Channel = NamePartsCells{4}; % Use 4 for 2colorWT, Use index 3 for Y27, Use index 4 for zip, Use index 4 for nls
    Frame   = NamePartsCells{6}; % Use 6 for 2colorWT, Use index 5 for Y27, Use index 6 for zip, Use index 6 for nls
